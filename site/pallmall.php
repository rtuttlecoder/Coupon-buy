...
if(isset($_POST['save-data']))
{
	...
	values ('Pall Mall','$type_of_coupon','$noofcoupons' ,'$userRow[userEmail]')";
...
$query2 = "select coupon_type from coupon_master where brand = 'Pall Mall' ";
...
<tr >
<td align="center" bgcolor ="#72b5e6"><font Color ="#e0eded"><h1>Pall Mall<h1></td></tr>
	</br>
	<tr>
...
sum(coupon_entry_total) as 'total'
 ...
 brand = 'Pall Mall' and invoice_no = '0' group by coupon_value";
...
<td align="center" bgcolor="white"style = "width:80px"><a href="deletepallmall.php?coupon_value=<? echo $rows['coupon_value']; ?>">
...
brand = 'Pall Mall' ORDER  BY id_coupon_entry desc LIMIT 1 ";
...
?>
<table>
 <td bgcolor="white"><b><?echo '<a href ="pallmalledit.php">Edit Last Invoice</a>'; ?><b></td>
 </tr>
 </table> 
<?php
	}
...
<table>
<td align="center" bgcolor ="white"><b><a href ="pallmallinvoiceno.php">Generate Invoice</a><b></td>
        </tr>
	</table>
	<?php }
	?>
