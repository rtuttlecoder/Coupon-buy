...
if(isset($_POST['save-data']))
{
	...
	values ('Fritolays','$type_of_coupon','$noofcoupons' ,'$userRow[userEmail]')";
	...
	$sql6 = "update coupon_entry set coupon_value = .59 where userEmail = '$userRow[userEmail]' ORDER  BY id_coupon_entry desc LIMIT 1";
...
$query2 = "select coupon_type from coupon_master where brand = 'Fritolays' ";
...
<tr >
<td align="center" bgcolor ="#72b5e6"><font Color ="#e0eded"><h1>Fritolays<h1></td></tr>
	</br>
	<tr>
...
sum(coupon_entry_total) as 'total'
 ...
 brand = 'Camel' and invoice_no = '0' group by coupon_value";
...
<td align="center" bgcolor="white"style = "width:80px"><a href="deletefritolays.php?coupon_value=<? echo $rows['coupon_value']; ?>">
...
brand = 'Fritolays' ORDER  BY id_coupon_entry desc LIMIT 1 ";
...
?>
<table>
 <td bgcolor="white"><b><?echo '<a href ="fritolaysedit.php">Edit Last Invoice</a>'; ?><b></td>
 </tr>
 </table> 
<?php
	}
...
<table>
<td align="center" bgcolor ="white"><b><a href ="fritolaysinvoiceno.php">Generate Invoice</a><b></td>
        </tr>
	</table>
	<?php }
	?>
