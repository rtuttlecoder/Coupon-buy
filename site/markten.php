...
if(isset($_POST['save-data']))
{
	...
	values ('Markten','$type_of_coupon','$noofcoupons' ,'$userRow[userEmail]')";
	...
	$sql7 = "update coupon_entry set coupon_value = ('$product_price' + total_tax)  where userEmail = '$userRow[userEmail]' ORDER  BY id_coupon_entry desc LIMIT 1";
	...
	$sql20 = "update coupon_entry set total_tax = ('$product_price' * 6.5/100 ) where userEmail = '$userRow[userEmail]' ORDER  BY id_coupon_entry desc LIMIT 1";
...
$query2 = "select coupon_type from coupon_master where brand = 'Markten' ";
...
<tr >
<td align="center" bgcolor ="#72b5e6"><font Color ="#e0eded"><h1>Markten<h1></td></tr>
	</br>
	<tr>
...
sum(coupon_entry_total) as 'total'
 ...
 brand = 'Markten' and invoice_no = '0' group by coupon_value";
...
<td align="center" bgcolor="white"style = "width:80px"><a href="deletemarkten.php?coupon_value=<? echo $rows['coupon_value']; ?>">
...
brand = 'Markten' ORDER  BY id_coupon_entry desc LIMIT 1 ";
...
?>
<table>
 <td bgcolor="white"><b><?echo '<a href ="marktenedit.php">Edit Last Invoice</a>'; ?><b></td>
 </tr>
 </table> 
<?php
	}
...
<table>
<td align="center" bgcolor ="white"><b><a href ="markteninvoiceno.php">Generate Invoice</a><b></td>
        </tr>
	</table>
	<?php }
	?>
