...
<html class="no-js">
	...
	<br>
	<br>
	<div align = "center"><h1>CHECK NOT RECEIVED STATEMENT</h1> </div>
...
brand as 'Brand' , sum(no_of_coupons) as 'Total Coupons',
 ...
 sum(coupon_entry_total) as 'Face Value' 
 FROM coupon_entry  where  check_received = 'no' and userEmail = '$userRow[userEmail]' group by invoice_no ";
...
<td align="center" bgcolor ="#d3dfdf"><h5>If Check Received<h5></td>
...
<td align ="center" bgcolor="white"><a href="check.php?invoice_no=<? echo $rows['invoice_no']; ?>">REMOVE</a></td>
