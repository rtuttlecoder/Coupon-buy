...
if(isset($_POST['save-data']))
{
	...
	values ('Camel','$type_of_coupon','$noofcoupons' ,'$userRow[userEmail]')";
...
$query2 = "select coupon_type from coupon_master where brand = 'Camel' ";
...
<tr >
<td align="center" bgcolor ="#72b5e6"><font Color ="#e0eded"><h1>Camel<h1></td></tr>
	</br>
	<tr>
...
<td align="center" bgcolor="white"style = "width:80px"><a href="deletecamel.php?coupon_value=<? echo $rows['coupon_value']; ?>">
...
brand = 'Camel' ORDER  BY id_coupon_entry desc LIMIT 1 ";
...
?>
<table>
 <td bgcolor="white"><b><?echo '<a href ="cameledit.php">Edit Last Invoice</a>'; ?><b></td>
 </tr>
 </table> 
<?php
	}
...
<table>
<td align="center" bgcolor ="white"><b><a href ="camelinvoiceno.php">Generate Invoice</a><b></td>
        </tr>
	</table>
	<?php }
	?>
