...
where brand= 'Newport' and userEmail ='$userRow[userEmail]'";
$result1 = (mysqli_query($con,$sql1));
while($rows=mysqli_fetch_array($result1))
$max_invoice_no = $rows['max'];
$sql13 = "update coupon_entry set invoice_no = '0' , invoice_date = '0000-00-00'
 
 WHERE userEmail = '$userRow[userEmail]' and invoice_no = '$max_invoice_no' and brand = 'Newport' and check_received = 'NO'";
