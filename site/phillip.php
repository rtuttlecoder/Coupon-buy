...
if(isset($_POST['save-data']))
{
	...
	values ('Phillip Morris','$type_of_coupon','$noofcoupons' ,'$userRow[userEmail]','0','no')";
...
$query2 = "select coupon_type from coupon_master where brand = 'Phillip Morris' ";
...
<tr >
<td align="center" bgcolor ="#72b5e6"><font Color ="#e0eded"><h1>Phillip Morris<h1><font Color ="black"><h4>(Marlboro, Pall Mall)</h4></td></tr>
	</br>
	<tr>
...
sum(coupon_entry_total) as 'total'
 ...
 brand = 'Phillip Morris' and invoice_no = '0' group by coupon_value";
...
?>
<table>
 <td bgcolor="white"><b><?echo '<a href ="phillipedit.php">Edit Last Invoice</a>'; ?><b></td>
 </tr>
 </table> 
<?php
	}
