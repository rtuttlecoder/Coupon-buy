...
if(isset($_POST['save-data']))
{
	...
	$sql = "insert into coupon_entry (brand,coupon_type,no_of_coupons,userEmail,invoice_no,check_received )
	values ('R J Reynolds','$type_of_coupon','$noofcoupons' ,'$userRow[userEmail]','0','no')";
	...
	$sql16 = "update coupon_entry set coupon_value = .75 where userEmail = '$userRow[userEmail]' ORDER  BY id_coupon_entry desc LIMIT 1";
...
$query2 = "select coupon_type from coupon_master where brand = 'R J Reynolds' ";
...
<tr >
<td align="center" bgcolor ="#72b5e6"><font Color ="#e0eded"><h1>R J Reynolds<h1><font Color ="black"><h4>(Newport, Camel, L & M)</h4></td></tr>
	</br>
	<tr>
...
sum(coupon_entry_total) as 'total'
 ...
 brand = 'R J Reynolds' and invoice_no = '0' group by coupon_value";
...
<td align="center" bgcolor="white"style = "width:80px"><a href="deletereynolds.php?coupon_value=<? echo $rows['coupon_value']; ?>">
...
brand = 'R J Reynolds' ORDER  BY id_coupon_entry desc LIMIT 1 ";
...
?>
<table>
 <td bgcolor="white"><b><?echo '<a href ="reynoldsedit.php">Edit Last Invoice</a>'; ?><b></td>
 </tr>
 </table> 
<?php
	}
...
<table>
<td align="center" bgcolor ="white"><b><a href ="reynoldsinvoiceno.php">Generate Invoice</a><b></td>
        </tr>
	</table>
	<?php }
	?>
