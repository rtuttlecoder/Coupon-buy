...
if(isset($_POST['save-data']))
{
	...
	values ('Marlboro','$type_of_coupon','$noofcoupons' ,'$userRow[userEmail]')";
...
$query2 = "select coupon_type from coupon_master where brand = 'Marlboro' ";
...
<tr >
<td align="center" bgcolor ="#72b5e6"><font Color ="#e0eded"><h1>Marlboro<h1></td></tr>
	</br>
	<tr>
...
sum(coupon_entry_total) as 'total'
 ...
 brand = 'Marlboro' and invoice_no = '0' group by coupon_value";
...
<td align="center" bgcolor="white"style = "width:80px"><a href="/deletemarlboro.php?coupon_value=<? echo $rows['coupon_value']; ?>">
...
brand = 'Marlboro' ORDER  BY id_coupon_entry desc LIMIT 1 ";
...
?>
<table>
 <td bgcolor="white"><b><a href ="marlboroedit.php">Edit Last Invoice</a><b></td>
 </tr>
 </table> 
<?php
	}
...
<table>
<td align="center" bgcolor ="white"><b><a href ="marlboroinvoiceno.php">Generate Invoice</a><b></td>
        </tr>
	</table>
	<?php }
	?>
